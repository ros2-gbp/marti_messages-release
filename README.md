## marti_messages (rolling) - 1.6.1-1

The packages in the `marti_messages` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling marti_messages` on `Fri, 06 Sep 2024 03:09:03 -0000`
...
## marti_messages (iron) - 1.6.1-1

The packages in the `marti_messages` repository were released into the `iron` distro by running `/usr/bin/bloom-release --edit --rosdistro iron marti_messages` on `Fri, 06 Sep 2024 03:04:27 -0000`
...
## marti_messages (humble) - 1.6.1-1

The packages in the `marti_messages` repository were released into the `humble` distro by running `/usr/bin/bloom-release --edit --rosdistro humble marti_messages` on `Fri, 06 Sep 2024 02:57:07 -0000`
...
## marti_messages (rolling) - 1.6.0-1

The packages in the `marti_messages` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling marti_messages` on `Fri, 09 Aug 2024 19:55:40 -0000`
...
## marti_messages (jazzy) - 1.6.0-1

The packages in the `marti_messages` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --edit --rosdistro jazzy marti_messages` on `Fri, 09 Aug 2024 19:37:57 -0000`
...
## marti_messages (iron) - 1.6.0-1

The packages in the `marti_messages` repository were released into the `iron` distro by running `/usr/bin/bloom-release --edit --rosdistro iron marti_messages` on `Fri, 09 Aug 2024 19:30:00 -0000`
...
## marti_messages (humble) - 1.6.0-1

The packages in the `marti_messages` repository were released into the `humble` distro by running `/usr/bin/bloom-release --edit --rosdistro humble marti_messages` on `Fri, 09 Aug 2024 19:24:56 -0000`
